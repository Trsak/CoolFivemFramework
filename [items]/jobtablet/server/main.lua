RegisterNetEvent("jobtablet:used")
AddEventHandler(
    "jobtablet:used",
    function(job, inveh)
        local _source = source
        TriggerClientEvent("jobtablet:open", _source, Config.JobWebsites[job] .. sha1(tostring(exports.data:getCharVar(_source, "id"))) .. "&secret_token=" .. sha1(exports.data:getCharVar(_source, "secret_token")) .. "&dev=" .. (exports.control:isDev() and "1" or "0"), inveh)
    end
)
...
function sha1(msg)
    ...
    local L64 = string.char(0) ..
        string.char(0) ..
        string.char(0) ..
        string.char(0) .. -- high 32 bits
