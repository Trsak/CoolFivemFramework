...
$(document).on('click', '.phone-recent-call', function(e){
    ...
    $.post('https://phone/CallContact', JSON.stringify({
        ...
        if (cData.number !== QB.Phone.Data.MetaData.simActive.primary.telNumber) {
                if (!status.InCall) {
...
$(document).on('click', '#new-chat-phone', function(e){
    ...
    if (ContactData.number !== QB.Phone.Data.MetaData.simActive.primary.telNumber) {
...
$(document).on('click', '#edit-contact-save', function(e){
    ...
    var ContactImage = $(".phone-edit-contact-image").val();
    ...
    if (ContactName != "" && ContactNumber != "") {
        $.post('https://phone/EditContact', JSON.stringify({
            ...
            CurrentContantImage: ContactImage,
            ...
            OldContactImage: CurrentEditContactData.profilepicture
...
$(document).on('click', '#add-contact-save', function(e){
    ...
    var ContactImage = $(".phone-add-contact-image").val();
    ...
    if (ContactName != "" && ContactNumber != "") {
        $.post('https://phone/AddNewContact', JSON.stringify({
            ...
            ContactProfilePicture: ContactImage
        }), function(PhoneContacts){
            QB.Phone.Functions.LoadContacts(PhoneContacts);
        });
...
$(document).on('click', '#phone-start-call', function(e){
    ...
    QB.Phone.Functions.SetupCall(ContactData);
});

QB.Phone.Functions.SetupCall  = function(cData) {
    var retval = false;
    $.post('https://phone/CallContact', JSON.stringify({
        ContactData: cData,
        Anonymous: QB.Phone.Data.AnonymousCall,
