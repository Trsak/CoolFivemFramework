...
function RadialMenu(params) {
    ...
    self.menuItems = params.menuItems ? params.menuItems : [{
        id: 'one',
        title: 'One'
    }, {
        id: 'two',
...
RadialMenu.prototype.close = function() {
    ...
    if (self.currentMenu) {
        $.post('https://rp/closemenu', JSON.stringify({}));
...
RadialMenu.prototype.createHolder = function() {
    ...
    self.holderMain = document.createElement('div');
    self.holderMain.className = 'menuHolderMain';

    self.parent.appendChild(self.holderMain);
    ...
    self.holderMain.appendChild(self.holder);
};
