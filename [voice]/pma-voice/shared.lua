...
Cfg.voiceModes = {
    ...
    { 3.0, "Normal" }, -- Whisper speech distance in gta distance units
    { 5.0, "Normal 2" }, -- Normal speech distance in gta distance units
    { 8.5, "Normal 3" }, -- Normal speech distance in gta distance units
